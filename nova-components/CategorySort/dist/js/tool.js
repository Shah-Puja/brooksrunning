...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getProducts: function getProducts(e) {
            var _this = this;

            this.showLoader = true;
            this.rankingSaved = false;
            this.showList = false;
            Nova.request().get('/nova-vendor/category-sort/products/' + e.target.value).then(function (response) {
                _this.products = response.data;
                _this.showList = true;
                _this.showLoader = false;
            });
        },
        saveRanking: function saveRanking(e) {
    ...
    created: function created() {
        ...
        Nova.request().get('/nova-vendor/category-sort/categories').then(function (response) {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Category Sort")]),
      _vm._v(" "),
      _c(
        "card",
        ...
        [
          _c(
            "select",
            {
              staticClass: "w-1/2 h-8 text-xl no-appearance bg-40 my-4",
            ...
            [
              ...
              _vm._l(_vm.categories, function(category) {
                return _c(
                  "option",
                  { domProps: { value: category.id + "_" + category.slug } },
                ...
                _vm._l(_vm.products, function(product) {
                  return _c(
                    "div",
                    {
                      key: product.id,
                      staticClass:
                        "flex justify-between items-center p-2 my-2 bg-40 cursor-move"
                    },
                    [
          ...
          _vm.rankingSaved
            ? _c(
                ...
                {
                  staticClass:
                    "w-1/3 p-4 my-2 mx-auto text-center bg-success text-white"
                },
                [_vm._v("Product ranking has been saved!")]
              )
            : _vm._e(),
          _vm._v(" "),
          _vm.showLoader
          ...
          _vm.showList
            ? _c(
                "button",
                {
                  staticClass: "btn btn-default btn-primary my-4",
                  attrs: { type: "button" },
                  on: { click: _vm.saveRanking }
                },
                [_vm._v("Save Sort Order")]
              )
            : _vm._e()
        ],
        1
