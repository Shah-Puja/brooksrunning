...
<div class="create-account--header plp-header category__hero" style="margin-bottom:0px;">
        ...
        <div class="row">
                    ...
                    <div class="about-header">
                        <div class="breadcrumbs">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="JavaScript:Void(0);" class="active">Revel 3 Breakthrough Collection</a>
                                         </li>
                                    </ul>
                                </div>
                            </div>
                            <h1 class="large">Train harder. Now Softer. </h1>
                        <p class="type">Chase down your goals with the Revel 3 Breakthrough Collection.
                        </p>
                    </div>
                </div>
            ...
            <div class="category__hero__image mob-12 col-6 tab-6 pr-0 pl-0">
                <img src="/images/Limited-Edition/revel3-breakthroughcollection-categoryimage.jpg">
            </div>
        </div>
</div>
...
<div class="create-account--header plp-header collection-intro">
  <div class="wrapper">
    ...
    <div class="col-2"></div>
      <div class="col-8">
      	<div class="about-header">
            <!-- <h1 class="br-mainheading">Train harder. Now Softer.</h1> -->
            <p>Styled to perform with maximum comfort, the Revel 3 Breakthrough Collection sports BioMoGo DNA cushioning that adapts to your stride to deflect impact. So you’re pumped to get through your toughest training day. Every day.</p>
        </div>
      </div>
      <div class="col-2"></div>
    </div>
			...
			<div class="row">
				<div class="tab-6 padding_0">
					<div class="collection-cate--link">
							<picture>
                                <source media="(max-width: 667px)" srcset="/images/Limited-Edition/revel3-breakthroughcollection/img_1.jpg">
                                <img src="/images/Limited-Edition/revel3-breakthroughcollection/img_1_2x.jpg"  alt="">
                            </picture>
					 </div>
				</div>
				<div class="tab-6 padding_0">
					<div class="collection-cate--link">
							 <picture>
                                <source media="(max-width: 667px)" srcset="/images/Limited-Edition/revel3-breakthroughcollection/img_2.jpg">
                                <img src="/images/Limited-Edition/revel3-breakthroughcollection/img_2_2x.jpg"  alt="">
                            </picture>
		...
		<div class="wrapper">
			<div class="row">
				<div class="tab-12 col-12 padding_0">
                    <picture>
                        <source media="(max-width: 595px)" srcset="/images/Limited-Edition/revel3-breakthroughcollection/img_3.jpg">
                        <img src="/images/Limited-Edition/revel3-breakthroughcollection/img_3_2x.jpg" alt="shoes">
                    </picture>
                </div>
            </div>
        </div>
