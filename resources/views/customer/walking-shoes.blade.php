  ...
  <div class="wrapper">
    <div class="row">
      <div class="col-8">
          ...
          <h1 class="br-mainheading">Walking Shoes</h1>
            <p>Give your feet the support they need with Brooks’ walking shoes, designed to provide comfort, functionality and durability through long periods of wear. By employing the most innovative technologies as well as using the highest quality materials, Brooks has engineered a stylish range of walking shoes that are lightweight, shock-absorbent and breathable. With cushioning stability technology and various fits to suit different foot types, you’re sure to find the perfect shoes here to suit your needs.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="ctg-discover">
	<div class="wrapper">
		<div class="row">
			<div class="cat-desc">
				<div class="col-12">
					<h2 class="">Find the Walking Shoes for You Today</h2>
					<p>We understand that every pair of feet is unique and that you may require assistance to find the right pair of walking shoes. Feel free to speak to our friendly staff today if you have any enquiries. We can provide recommendations to help you find the pair that’s best suited to your feet.</p>
				</div>
			</div>
		</div>
	</div>
