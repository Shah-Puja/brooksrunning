        ...
        <div class="col-9 tab-8">
            ...
            <div class="shipping-right--container">
                ...
                <div class="medibank_guest_div">
                    <p>Please log in with your Medibank Membership number and the email address registered with your My Medibank account.</p>
                ...
                @if(Session::get('medibank_gateway')=='Yes')
                <div class="shipping-main-form" @if(Session::get('medibank_user')=='Yes') style="display: block;" @else style="display: none;" @endif>
                     @else
                     ...
                     <form name="billing_shipping" id="billing_shipping" method="post" action="/shipping" onsubmit="return shippingform_validate()">
                            ...
                            <div class="shipping-form">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="input-wrapper">
                                            ...
                                            @if(Session::get('medibank_gateway')=='Yes')
                                            <input type="text" id ="reset_email" value="{{Session::get('medibank_user_email')}}" name="email" class="input-field main_email_field" data-label-name="email">
                                            @else
                                ...
                                @include('customer.shipping_login_form') 
                                @endif
                                <!-- /Password Wrapper -->
                                        ...
                                        <div class="input-wrapper">
                                            <div class="checklist-inline">
                                                <input type="checkbox" id="signme" name="signme" value='1'  @if ( old('signme') == 1) checked @endif   @if(isset(auth()->user()->newsletter) && auth()->user()->newsletter=='1') checked @endif>
                                                       <label for="signme">
                                                    <div class="mark"><span></span></div>
                                                    <div class="text" style="font-size:14.5px;">Check this box if you wish to receive communication from Brooks on new products, exclusive offers and info to help you Run Happy.</div>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
