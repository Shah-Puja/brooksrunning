...
<div class="create-account--header plp-header category__hero" style="margin-bottom:0px;">
        ...
        <div class="row">
                    ...
                    <div class="about-header">
                        <div class="breadcrumbs">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="JavaScript:Void(0);" class="active">Melts Collection</a>
                                         </li>
                                    </ul>
                                </div>
                            </div>
                            <h1 class="large">Speed by the scoop</h1>
                        <p class="type">Ice cream tastes better after a PB — it’s a fact. 
                        </p>
                    </div>
                </div>
            ...
            <div class="category__hero__image mob-12 col-6 tab-6 pr-0 pl-0">
                <img src="/images/Limited-Edition/melts/melts-collection-ghost12-ricochet-categoryimage.jpg">
            </div>
        </div>
</div>
			...
			<div class="row">
				<div class="tab-6 padding_0">
					<div class="collection-cate--link">
							<picture>
                                <source media="(max-width: 667px)" srcset="/images/Limited-Edition/melts/w_ricochet_img.jpg">
                                <img src="/images/Limited-Edition/melts/w_ricochet_img_2x.jpg"  alt="">
                            </picture>
					 </div>
				</div>
				<div class="tab-6 padding_0">
					<div class="collection-cate--link">
							 <picture>
                                <source media="(max-width: 667px)" srcset="/images/Limited-Edition/melts/m_ghost_img.jpg">
                                <img src="/images/Limited-Edition/melts/m_ghost_img_2x.jpg"  alt="">
                            </picture>
				...
				<div class="tab-6 padding_0">
					<div class="collection-cate--link">
							<picture>
                                <source media="(max-width: 667px)" srcset="/images/Limited-Edition/melts/w_ghost_img.jpg">
                                <img src="/images/Limited-Edition/melts/w_ghost_img_2x.jpg"  alt="">
                            </picture>
					 </div>
				</div>
				<div class="tab-6 padding_0">
					<div class="collection-cate--link">
							 <picture>
                                <source media="(max-width: 667px)" srcset="/images/Limited-Edition/melts/m_ghost_img_2.jpg">
                                <img src="/images/Limited-Edition/melts/m_ghost_img_2_2x.jpg"  alt="">
                            </picture>
...
<section class="wrapper pr-collection-page collectionpg-bottom--banner melts-comp-bottom-banner pr-0 pl-0">
	<div class="prod-desc--wrapper">
		<div class="wrapper">
			<div class="row">
				<div class="tab-12 col-12 padding_0">
                    <div class="melts_comp_img_over">
                        <picture>
                            <source media="(max-width: 595px)" srcset="/images/Limited-Edition/melts/ice_cream_section_950px.jpg">
                            <img src="/images/Limited-Edition/melts/ice_cream_section.jpg" alt="shoes" class="melts_comp_img_banner">
                        </picture>
                        <img src="/images/Limited-Edition/melts/melts_illustration.png" class="melts_comp_img_logo"/>
                    </div>
                </div>
            </div>
        </div>
