...
<div class="create-account--header">
	<div class="wrapper">
		<div class="row">
			<div class="col-7">
				<h1 class="br-mainheading">SALE!</h1>
				<p>Looking for running shoes and accessories that won't break your budget? Brooks has you covered with a variety of sale items across our massive range of running shoes and clothing. Whether you're on the hunt for affordable women's running shoes or you want to score a bargain on men's running clothing, you'll find all of our current sale products on this page.</p>
			</div>
		</div>
	</div>
</div>
				...
				<div class="sale-container--wrapper">
					<div class="img-wrapper">
						...
						<div class="img-info">
							...
							<a href="#" class="secondary-button btn">Shop Now</a>
						</div>
					</div>
