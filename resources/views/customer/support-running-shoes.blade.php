  ...
  <div class="wrapper">
    <div class="row">
      <div class="col-8">
          ...
          <h1 class="br-mainheading">Support Running Shoes</h1>
            <p>The best running shoes for overpronation must offer an excellent support system to prevent runners from incurring potential injuries. Those with neutral feet have a substantial feet arch which helps them to absorb the shock of the foot landing on the ground, but people with flat feet will experience excessive inwards rolling of the foot. For this reason, Brooks’ stability running shoes have been engineered to provide support, motion control and great comfort, making them the best running shoes for overpronation.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="ctg-discover">
	<div class="wrapper">
		<div class="row">
			<div class="cat-desc">
				<div class="col-12">
					<h2 class="">Choose from a Wide Selection</h2>
					<p>Our women’s cushioned running shoes are designed not only to provide excellent support, but also to add a stylish accent to your training. Browse our collection to find a variety of attractive designs. If you require any assistance in finding the perfect running shoes for flat feet, our friendly team members are on-hand to provide advice.</p>

					<p>We also offer free delivery anywhere in Australia when you spend more than $50 – place your order today!</p>
				</div>
			</div>
		</div>
	</div>
