  ...
  <div class="wrapper">
    <div class="row">
      <div class="col-8">
          ...
          <h1 class="br-mainheading">Trail Running Shoes</h1>
            <p>Beat rocky terrains and steep hills with Brooks’ trail running shoes, designed to withstand the harsh elements of off-road travel. Featuring increased support, enhanced durability and excellent waterproofing, these long distance running shoes aren’t just functional, but are also stylish with a wide variety of colours and options to choose from. <br/>
			Unlike standard running shoes, the best trail running shoes have uppers made of breathable materials that will swiftly shed water while possessing a durability that will protect against abrasions – resulting in high-quality trail running shoes that can withstand abuse for a long time.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="ctg-discover">
	<div class="wrapper">
		<div class="row">
			<div class="cat-desc">
				<div class="col-12">
					<h2 class="">Free Delivery for Orders Over $50</h2>
					<p>Browse our range to find a variety of long distance running shoes to suit your needs – and order online to receive free Australia-wide delivery on orders over $50! Discover the best trail running shoes within our extensive selection today.</p>
				</div>
			</div>
		</div>
	</div>
