...
<div class="row" style="" id="learn_more">
		<div class="col-9">
			<div class="create-account--left">
				...
				<p class="heading_learn_more">Adrenaline GTS 19  </p>
				</div>
				<div class="row">
					<div class="col-12">
								...
								<div class="shoes-wrapper-container">
										...
										<div class="shoes-wrapper__sub">
											<div class="shoe-product">
												<div class="img img-shoes">
													<img src="https://brooksrunning.texaspeak.com.au/shoes/pages/adrenaline-gts/mens.jpg" alt="">
												</div>
												<div class="info">
									...
									<div class="mob-12 col-6 tab-12">
										<div class="shoes-wrapper__sub">
											<div class="shoe-product">
												<div class="img img-shoes">
													<img src="https://brooksrunning.texaspeak.com.au/shoes/pages/adrenaline-gts/womens.jpg" alt="">
												</div>
												<div class="info">
													<div class="shoes-detail-btn">
            ...
            <div class="privacy-content">
            	<div class="privacy-content">
					...
					<ol>
					  	...
					  	<li>The winner of the Promotion will be chosen at random. The prizes must be claimed before 5pm AEST on 15th March 2019 otherwise a redraw will occur. If in the event the prize is not claimed, a redraw will occur on the 18th March at 12:00pm AEST at the premises of Fit Chain. The winner will be notified by email.</li>
					  	<li>Prize is as follows::
					    		<ul>
					            	<li> 1 x Brooks Adrenaline GTS 19 (RRP $219.95)</li>          
					    		</ul></li>
					    <li>In conjunction with permit regulations, for any promotion conducted no individual prize will exceed $1,000 AUD and the total value of prizes will not exceed $100,000 AUD. NSW Permit No. LTPM/18/03786.    </li>
					  	<li>The Promoter reserves the right to request the winner to provide proof of their identity and proof of Australian residency in order to claim the prize. Proof of identification and residency is at the judgment of the promoter.</li>
