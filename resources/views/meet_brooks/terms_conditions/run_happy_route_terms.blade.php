...
<ol>
    ...
    <li>To enter via Instagram participants must complete the following in the promotional period:
        <ol style="margin-left: 35px; margin-top:15px; margin-bottom: 15px;">
              <li>Record their favourite Run Happy Route on any run mapping app</li>
              <li>Post a screenshot of their run on their Instagram</li>
              <li>#RunHappyRoute & tag @brooksrunningau on the post</li>
        </ol>
    </li> 
    <li>Entry Limits: Participants can enter as multiple times by posting different running routes and following the entry steps. </li>
    ...
    <li>The winners of the Promotion will be chosen at random. The prizes must be claimed before 5pm AEST on 25<sup>th</sup> October 2019 otherwise a redraw will occur. If in the event the prize is not claimed a redraw will occur on the 28<sup>th</sup> October 2019 at 12:00pm AEST at the premises of Texas Peak. </li>
    <li>Prizes are as follows:
        <ul style="margin-left: 35px; margin-top:15px; margin-bottom: 15px;">
              <li>- 1 x Brooks footwear selected by each winner (3 winners total)</li>
