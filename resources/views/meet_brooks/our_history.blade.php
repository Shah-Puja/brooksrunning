...
<div id="meet-history">
        ...
        <div id="start">
            <section class="meet">
                <div class="center">
                    <p class="para timeline-date center large">1914</p>
                </div>
            </section>
            ...
            <section class="meet">
                <div class="center">
                    <p class="para timeline-date center large">1921</p>
                </div>
            </section>
            ...
            <section class="meet">
                    <div class="center">
                        <p class="para timeline-date center large">1929</p>
                    </div>
            </section>
            ...
            <section class="meet">
                <div class="center">
                    <p class="para timeline-date center large">1930</p>
                </div>
            </section>
            ...
            <div class="center">
                <p class="para timeline-date center large">1938</p>
            </div>
            <section id="childrens" class="timeline-entry">
                <div>
                    <p class="para medium center subhed subhed--no-img">
                        Children's Shoes
                    </p>
            ...
            <div class="center">
                <p class="para timeline-date center large ">1940</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">1962</p>
            </div>
        ...
        <div id="rise" class="is-hidden">
            <div class="center">
                <p class="para timeline-date center large">1972</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">1974</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">1977</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">1980</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">1981</p>
            </div>
            <section id="varus" class="timeline-entry">
                <div>
                    <p class="para medium center subhed">
                        Varus Wedge
                    </p>
                    <p class="para graf graf--center">
            ...
            <div class="center">
                <p class="para timeline-date center large">1982</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">1987</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">1989</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">1992</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">1995</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">1999</p>
            </div>
        ...
        <div id="focus" class="is-hidden">
            <div class="center">
                <p class="para timeline-date center large">2001</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">2002</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">2006</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">2007</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">2011</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">2013</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">2017</p>
            </div>
            ...
            <div class="center">
                <p class="para timeline-date center large">2018</p>
            </div>
