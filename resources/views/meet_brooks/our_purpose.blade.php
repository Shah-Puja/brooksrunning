...
<section id="top" class="meet">
  <p class="para meet-title center">
      Our Purpose
  </p>
...
<section id="purpose-video">
  ...
  <div class="component-content">
                ...
                <figure class="m-block--video-player m-block--flexible-module ratio-container ratio-container--benefits col-sm-2--site__wrapper col-md-4--site__wrapper col-10 no-float site__wrapper--margin" style="margin-bottom: 0;">
                  ...
                  <figure class="m-block--video-player m-block--flexible-module ratio-container ratio-container--benefits col-sm-2--site__wrapper col-md-4--site__wrapper col-10 no-float site__wrapper--margin" style="margin-bottom: 0;">
                    <iframe id="benefits-video_de1c1a0e-f52c-4410-a1c0-0a3a1d975f53" allow="autoplay; encrypted-media" class="product-container__video-youtube" data-id="dLnuE7m62U0" src="https://www.youtube.com/embed/aUQ94SAENak?rel=0&amp;amp;controls=0&amp;amp;showinfo=0&quot; frameborder=&quot;0&quot; allow=&quot;autoplay; &amp;enablejsapi=1&amp;origin=https%3A%2F%2Fwww.brooksrunning.com.au" frameborder="0" data-aspectratio="0.562494938735338" data-gtm-yt-inspected-2174125_976="true"></iframe>
                  </figure>
                </figure>

                <!-- DEBUG VIEW -->
                <section class="br-video-player-data-container red hide">
                  <div> TBN Desktop: /imgaes/Meet-Brooks-Refresh/meet_video_still.jpg</div>
                <div> TBN Mobile : /imgaes/Meet-Brooks-Refresh/meet_video_still_sm.png</div>
                <div> Video : https://www.youtube.com/embed/aUQ94SAENak?rel=0&amp;amp;controls=0&amp;amp;showinfo=0" frameborder="0" allow="autoplay; </div>
                <div> Title : </div>
                <div> Subtitle : </div>
...
<section id="the-run">
      <img src="/images/Meet-Brooks-Refresh/MeetBrooks_mobile_595x1200_1.jpg" alt="">
        <div class="section_block _top">
          <p class="para large center subhed--center subhed--wide">
              We live by the following:
          </p>
      <br/>
          <div class="center meet">
              <p class="para timeline-date center large">1</p>
          </div>
          <p class="para large center subhed subhed--wide">
              Running is a gift. Run happy.
          </p>
          <p class="para center graf">
...
<section id="one-thing" class="meet">
  <div class="center meet">
  <p class="para timeline-date center large" style="color: #ffffff;">2</p>
  </div>
  <p class="para large center subhed subhed--white subhed--wide">
      We do one thing: build great running gear.
  </p>
  <p class="para center graf graf--white">
...
<section id="third-sect">
  ...
  <div class="section_block">
      <div class="center meet">
          <p class="para timeline-date timeline-date--white center large">3</p>
      </div>
      <p class="para large center subhed subhed--wide subhed--white">
...
<section id="sweat">
  <img src="/images/Meet-Brooks-Refresh/MeetBrooks_mobile_595x1200_3.jpg" alt="">
    <div class="sweat-text">
        <div class="center meet">
            <p class="para timeline-date timeline-date--white center large">4</p>
        </div>
        <p class="para large center subhed subhed--white">
            We sweat every detail.
        </p>
        <p class="para center _left graf graf--white">
...
<section id="community">
  <img src="/images/Meet-Brooks-Refresh/MeetBrooks_mobile_595x1200_4.jpg" alt="">
    <div class="section_block mid">
        <div class="center meet">
            <p class="para timeline-date timeline-date--white center large">5</p>
        </div>
        <p class="para large center subhed subhed--wide subhed--white">
...
<section id="we-run">
  ...
  <div class="section_block">
    <div class="center meet">
        <p class="para timeline-date center large">6</p>
    </div>
    <p class="para large center subhed">
        We're runners, too.
    </p>
    <p class="para center graf">
...
<section id="message" class="meet">
  <p class="para medium center graf">
      Welcome to Brooks
  </p>
  <p class="para graf graf--center">
  ...
  <p class="para center graf">Jim Weber, Brooks Running CEO</p>
</section>

<section id="links" class="meet">
  <p class="para medium center subhed subhed--large">
      Get to know us better
  </p>
  <p class="para graf center graf--wide">
