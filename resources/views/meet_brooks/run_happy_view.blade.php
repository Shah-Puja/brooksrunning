...
<section class="brooksrunhappyis hidden-mob">
			...
			<div class="info-wrapper">
				  <div class="row gridcontainer">
				     ...
				     <div class="tab-7 padd_00">
				      ...
				      <div class="tab-2 padd_00 aqua-bkgd padd_b_16">
							<div class="txtYoung">
						      <h3><span  class="yellow">Young and old, </span>
						      <span class="white">	fast or slow,<br>
						      male or female,<br>
						      master or newbie.</h3>
					      </div>
				     </div>
			...
			<div class="info-wrapper ">
				  <div class="row blue-bkgd">
				     ...
				     <div class="tab-4 padd_00">
				       <div class="txtTap">
					        <h3><span class="yellow">When we tap into Run Happy,</span>
					        we celebrate this thing we, and all runners, love.
					      </h3>
					  </div>
				     </div>
	   			</div>
	...
	<section class="module">
		<div class="wrapper">
			<div class="info-wrapper">
				  <div class="row dark-grey-bkgd">
				     <div class="tab-2 padd_00 ">
				       <div class="txtReminds"><h3><span class="yellow">The words<br>
					      Run Happy</span><br>
					      remind runners everywhere why they fell in love with running in the first place.</h3>
					  </div>
				     </div>
				     <div class="tab-4 padd_00">
				       <div class="top_prd_sec ">
				  ...
				  <div class="row">
				     ...
				     <div class="tab-4 padd_00">
				      ...
				      <div class="tab-4 padd_00 darkest-grey-bkgd padd_b_3">
	      					<h2 class="txtTip tip  yellow ">THE TIP OF OUR SPEAR</h2>
				     </div>
	   			</div>
			</div>
		</div>
...
<section class="brooksrunhappyis visible-mob">
				  ...
				  <div class="row gridcontainer">
				     <div class="mob-6 padd_00">
				      <div class="mobtxtLeft">
					         <span class="white">It's a feeling, an attitude,<br>
        					a spirit that lives in the hearts and minds of all runners—</span>
					    </div>
				     </div>
				      <div class="mob-6 padd_00">
			...
			<div class="info-wrapper">
				  <div class="row gridcontainer">
				     <div class="mob-6 padd_00">
				      ...
				      <div class="mob-6 padd_00">
							<div class="mobtxtLeft">
						        <span class="white">Young and old,</span><br>
						        <span class="white">fast or slow,<br>
						        male or female,<br>
						        master or newbie.</span>
						    </div>
				     </div>
	   			</div>
			</div>
	...
	<section class="module">
			<div class="info-wrapper">
				  <div class="row gridcontainer">
				     <div class="mob-6 padd_00">
				      <div class="mobtxtLeft">
       						 <span class="white"> Run Happy is each runner's deep and meaningful love of running.</span>
      					</div>
				     </div>
				      <div class="mob-6 padd_00">
						<div class="top_prd_sec">
			...
			<div class="info-wrapper">
				  <div class="row gridcontainer">
				     <div class="mob-6 padd_00">
				      ...
				      <div class="mob-6 padd_00">
							<div class="mobtxtLeftThin">
					            <span class="white"> And because of that,<br> Run Happy is...</span>
					      </div>
				     </div>
	   			</div>
			</div>
	...
	<section class="module">
			<div class="info-wrapper">
				  <div class="row gridcontainer">
				     <div class="mob-6 padd_00">
					      <div class="mobtxtLeft hall">
					        <span class="white">Run Happy is the best part of the runner's day, the part that understands that the worst day spent running is better than the best day at the office.</span>
					    </div>
				     </div>
				      <div class="mob-6 padd_00">
						<div class="top_prd_sec">
			...
			<div class="info-wrapper">
				  <div class="row gridcontainer">
				     <div class="mob-6 padd_00">
				      ...
				      <div class="mob-6 padd_00">
							<div class="mobtxtLeft">
						        <span class="white">When we tap into Run Happy,<br>
						        	we celebrate this thing we, 
        							and all runners, love.</span>
						    </div>
				     </div>
	   			</div>
			</div>
			...
			<div class="info-wrapper">
				  <div class="row gridcontainer">
				     <div class="mob-6 padd_00">
				      ...
				      <div class="mob-6 padd_00">
							<div class="mobtxtLeft">
						        <span class="white">That is why, </span>
						        <span class="yellow">Run Happy is...</span>
						    </div>
				     </div>
	   			</div>
			</div>
			...
			<div class="info-wrapper">
				  <div class="row gridcontainer">
				     <div class="mob-6 padd_00">
				      ...
				      <div class="mob-6 padd_00">
						      <div class="mobtxtRight yellow p40">
