...
class PaymentController extends Controller {
    ...
    public function ap21order($person_id) {
        ...
        $carrier = $servicetype =  $courier_text = '';
        if ($order->delivery_type == "express") {
            ...
            if (!empty($freight_service_info) && $freight_service_info->postcode === $this->order->address->s_postcode) {
                ...
                if($carrier=='CPL'){
                    $courier_text = "Signature Required";
                }
            }
        }
        ...
        $xml_data .= "<DeliveryInstructions>" . $add_description . $order_instruction . $atl . $courier_text . "</DeliveryInstructions>";
        $xml_data .= "<Addresses>
                    <Billing>
