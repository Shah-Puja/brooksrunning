...
class Competition extends Resource
{
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make('Form File Name','comp_form')->onlyOnDetail(),
            Textarea::make('Form HTML','comp_form_html')->hideFromIndex(),
            Text::make('Terms Conditions File Name','terms_conditions')->onlyOnDetail(),
