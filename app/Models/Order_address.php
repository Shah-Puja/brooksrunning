...
{
    protected $fillable = ['order_id', 'email', 'fname', 'lname', 'b_add1', 'b_add2', 'b_city', 'b_state', 'b_postcode', 'b_phone', 
    ...
    public static function prepareAddressForSaving($address) {
        ...
        if ( $address['flag_same_shipping'] == "Yes" ) {
            $address['b_fname'] = $address['fname'];
            $address['b_lname'] = $address['lname'];
